...
#The bootstrapping process can run for long periods of time. Creating a progress bar can be helpful. 
...
for (boot in 1:200) {
  ...
  write.csv(results, "boot_results_date.csv", row.names = FALSE, na = "")
